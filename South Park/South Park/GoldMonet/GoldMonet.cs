...
namespace South_Park
{
   ...
   // Нарисовать три вида монет. Большие средние и маленьки.(анимация)
   // Будут приносить разное ко-во золота в зависимости от размера



    class GoldMonet : IGameObject
    {
        ...
        public GoldMonet(Game game)
        {
            ...
            animation = new Animation(game, SPHalper.ContentManager.Load<Texture2D>("GoldMonet/GoldMonet"), new System.Drawing.Size(32, 32),
                                      this.Location, 25, 11);
            timer = 0;
        }
