...
namespace South_Park
{
    ...
    class Medic : IGameObject
    {
        ...
        public Medic(Game game)
        {
            ...
            animation = new Animation(game, SPHalper.ContentManager.Load<Texture2D>("Bonus/Medic/Medic"), new System.Drawing.Size(32, 32),
                                      this.Location, 8, 1);
            timer = 0;
        }
